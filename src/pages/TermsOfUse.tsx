    ...
    <div className="min-h-screen p-6" style={{ background: 'var(--bg-app)', color: 'var(--text-main)' }}>
      <div className="max-w-3xl mx-auto py-12">
        ...
        <header className="mb-12">
          ...
          <p className="text-sm font-bold uppercase tracking-widest text-gray-500">Terms of Use</p>
        </header>

        <section className="space-y-12 leading-relaxed">
          <div className="space-y-4">
            <h2 className="text-xl font-bold border-l-4 border-indigo-500 pl-4 py-1">1. 規約の適用</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold border-l-4 border-indigo-500 pl-4 py-1">2. サービスの提供と免責</h2>
            <p className="font-medium">
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold border-l-4 border-indigo-500 pl-4 py-1">3. 知的財産権</h2>
            <p className="font-medium">
